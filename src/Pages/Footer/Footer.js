        ...
        <>
            <div className="py-8 w-full mt-20 bg-gray-700">
                <div className="container mx-auto px-8">
                    <div className="grid md:grid-cols-5 no-underline w-full text-white">
                        <div className="h-10 w-10 self-center mr-2 flex flex-row">
                            ...
                            <Link to="/home" className="md:text-3xl no-underline text-grey-darkest hover:text-blue-200 font-sans font-bold">Dentessa</Link><br />
                        </div>
                ...
                <div className="text-center pb-2 text-white">
                    <small><i><a href="http://www.freepik.com">Logos and images sourced from Freepik</a></i></small> <br />
