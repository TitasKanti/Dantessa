                ...
                <div className="flex items-center flex-col md:flex-row justify evenly">
                    <div className="p-4">
                        <div className="text-center mb-4 opacity-90">
                            ...
                            <img alt="profil" src="https://image.freepik.com/free-photo/pleased-young-female-doctor-wearing-medical-robe-stethoscope-around-neck-standing-with-closed-posture_409827-254.jpg" className="mx-auto object-cover rounded-full h-40 w-40 " />
                    ...
                    <div className="p-4">
                        <div className="text-center mb-4 opacity-90">
                            ...
                            <img alt="profil" src="https://image.freepik.com/free-photo/hospital-healthcare-workers-covid-19-treatment-concept-young-doctor-scrubs-making-daily-errands-clinic-listening-patient-symptoms-look-camera-professional-physician-curing-diseases_1258-57233.jpg"
                    ...
                    <div className="p-4">
                        <div className="text-center mb-4 opacity-90">
                            ...
                            <img alt="profil" src="https://image.freepik.com/free-photo/medical-workers-covid-19-vaccination-concept-confident-professional-doctor-female-nurse-blue-scrubs-stethoscope-show-thumbs-up-assure-guarantee-best-quality-service-clinic_1258-57360.jpg" className="mx-auto object-cover rounded-full h-40 w-40 " />
